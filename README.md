...
Private Fahrrad-Stadtführung durch Paris (halber Tag, Start am Hotel PiaPia + 9 Stationen) zu Klimaschutz, Klimaanpassung und nachhaltigem Wirtschaften — für eine Reise Anfang September 2026.
...
- [ ] **La Caverne (Station 9)**: Innenbereich vermutlich nur mit Anmeldung/Führung zugänglich — vorher klären, sonst reicht die Fassade
...
- [ ] **Velo-Infrastruktur an zwei Stellen nicht verifiziert**: (1) Hotel → Station 1 (Rivoli, ~5-6 km quer durch die Stadt, neu dazugekommen, nie geprüft), (2) Station 5 → 7 (Bassin d'Austerlitz → Petite Ceinture → École Keller). Der vorgeplante Maps-Link nimmt irgendeine Route, nicht garantiert auf Velostrassen — an beiden Stellen am Tourtag live navigieren statt dem Link blind folgen. Strecken 1–5 und 7–9 (via Canal Saint-Martin/Boulevard Magenta, inkl. neuem Abstecher zu Station 8) sind dagegen gut ausgebaut.
...
Google Maps zeigt beim Öffnen des "Ganze Route"-Links automatisch La Recyclerie und Paname Brewing Company als hervorgehobene Orte entlang der Strecke an (Googles eigene POI-Vorschläge, nicht von uns gesetzt). La Recyclerie — ein altes Bahnhofsgebäude der Petite Ceinture (Gare d'Ornano), seit 2014 zu Restaurant/Werkstatt/Stadtfarm umgebaut — passte inhaltlich zu gut, um es zu ignorieren: direkter Bezug zu Station 6 (dieselbe Bahnlinie), nur diesmal aktiv gestaltet statt sich selbst überlassen. Liegt mit ~1,25 km nur unwesentlich abseits der direkten Strecke Station 7 → Station 9 (Direktweg: ~4,8 km, mit Abstecher: ~5,4 km + 1,25 km). Dadurch wurde aus der bisherigen Station 8 (La Caverne) Station 9. Paname Brewing Company (Canal de l'Ourcq, 19e) liegt dagegen ~3,8 km von Station 7 entfernt, klar ausserhalb der Route — kam stattdessen auf `karte-vegan-bier.html`.
